...
const Cart = () => {
    ...
    const {products, updateCartItem, removeFromCart, currency, cartItems, getCartCount,  getCartAmount, navigate, axios, user, setCartItems} = useAppContext();
...
// logic inside placeOrder write at backend code
                        ...
                        <div className="flex items-center md:gap-6 gap-3">
                            ...
                            <div>
                                ...
                                <div className="font-normal text-gray-500/70">
                                    <p>Wieght: <span>{product.weight || "N/A"}</span></p>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        <button onClick={() => setShowAddresses(!showAddresses)} className="text-primary hover:underline cursor-pointer">
                            Change
                        </button>
                        {showAddresses && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                              {addresses.map((address,index)=>(
                                  <p onClick={() =>{ setSelectedAddresses(address);setShowAddresses(false)}} className="text-gray-500 p-2 hover:bg-gray-100">
