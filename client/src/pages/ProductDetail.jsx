...
const ProductDetail = () => {
    ...
    useEffect(() => {
        ...
        productCopy = products.filter((item)=> item.category === product.category)
    ...
    return product && (
        <div className="mt-12">
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <button onClick={()=>{navigate("/products"); scrollTo(0,0)}} className="mx-auto px-12 my-16 py-2.5 cursor-pointer rounded border text-primary hover:bg-primary/10 transition">See more</button>
            </div>
        </div>
    );
};
