...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
        ...
        <div className='absolute flex flex-col items-center inset-0 md:items-end md:justify-center pt-16 md:pt-0 md:pr-24'>
            <div>
                <h1 className='text-2xl md:text-3xl font-semibold text-primary mb-6'>Why We Are The Best ?</h1>
                {features.map((feature,index)=>(
                    <div key={index} className='flex items-center mt-2 gap-4 p-2'>
